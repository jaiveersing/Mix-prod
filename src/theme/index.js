export default {
	...
	"fontFamily": {
		...
		"googleAbel": "\"Abel\", sans-serif",
		"googleKaushanScript": "\"Kaushan Script\", cursive",
		"googleArchitectsDaughter": "\"Architects Daughter\", cursive",
	...
	"background": {
		"primaryGradient": "linear-gradient(180deg,--color-primary 78.7%,transparent 90.9%) 0 0 no-repeat",
